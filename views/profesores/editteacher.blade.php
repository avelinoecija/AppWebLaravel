      ...
      <div class="card">
        ...
        <form class="col-md-12" action="#" method="POST">
            ...
            <div class="form-group">
               ...
               <input type="text" name="name" id="name" class="form-control" value="{{$profesor['nombre']}}">
            </div>

            <div class="form-group">
               <label for="subname">Apellido</label>
               <input type="text" name="subname" id="subname" class="form-control" value="{{$profesor->apellido}}">
            </div>

            <div class="form-group">
               <label for="email">Departamento</label>
               <input type="text" name="email" id="email" class="form-control" value="{{$profesor->departamento}}">
            </div>

            <div class="form-group">
               <label for="password">Alumno</label>
               <input type="text" name="password" id="password" class="form-control" value="{{$profesor->id}}">
            </div>

            <div class="form-group">
                <label for="address">Asignatura</label>
                <input type="text" name="address" id="address" class="form-control" value="{{$profesor->idasignatura}}">
            </div>
